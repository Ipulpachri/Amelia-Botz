...
➵͜͡✪ Nama : ${pushname}
➵͜͡✪ Status : ${isPremium ? '🎫 Premium':'Free'}
➵͜͡✪ Limit : ${isPremium ? 'Unlimited' : `${getLimit(senderNumber, limitCount, user)}/${limitCount}`}
➵͜͡✪ Saldo : Rp ${getBalance(senderNumber, user).toLocaleString()}
➵͜͡✪ Prefix :「  ${thePrefix}  」
➵͜͡✪ Mode : ${publik ? "Public" : "Self"}
➵͜͡✪ Active : ${kyun(process.uptime())}
➵͜͡✪ Time : ${timeWib} WIB
➵͜͡✪ Time : ${timeWit} WIT 
➵͜͡✪ Time : ${timeWita} WITA
➵͜͡✪ Islamic : ${dateIslamic}
➵͜͡✪ Hit Today : ${thisHit.toLocaleString()}
➵͜͡✪ Total User : ${JSON.parse(fs.readFileSync('./database/user.json')).length.toLocaleString()}
➵͜͡✪ Total Error : ${JSON.parse(fs.readFileSync('./database/listerror.json')).length}
➵͜͡✪ User Banned : ${JSON.parse(fs.readFileSync('./database/banned.json')).length}
➵͜͡✪ User Blocked : ${JSON.parse(fs.readFileSync('./database/userblocked.json')).length} 
➵͜͡✪ Cmd Blocked : ${JSON.parse(fs.readFileSync('./database/blockcmd.json')).length} 
